 ...
 */
@:buildXml('<include name="../../../../source/jta/external/memory/build.xml" />')
@:include("memory.hpp")
extern class Memory
{
	/**
...
class Memory
{
	 ...
	 * Returns 0.
	 */
	public static inline function getPeakUsage():UInt
		return 0;
	 ...
	 * Returns 0.
	 */
	public static inline function getCurrentUsage():UInt
		return 0;
}
#end
